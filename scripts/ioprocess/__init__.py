import os
from select import poll, POLLERR, POLLHUP, POLLPRI, POLLOUT, POLLIN, POLLWRBAND
...
from vdsm.constants import EXT_IOPROCESS
from base64 import b64decode, b64encode
import stat

from misc import NoIntrPoll, dict2namedtuple
...
class IOProcess(object):
    ...
    _log = logging.getLogger("storage.IOProcessClient")
    _sublog = logging.getLogger("storage.IOProcess")
    ...
    def _run(self):
        ...
        self._partialLogs = ""
        p = BetterPopen([self.IOPROCESS_EXE,
    ...
    def _startCommunication(self, proc, readPipe, writePipe):
        t = Thread(target=self._communicate, args=(proc, readPipe, writePipe))
        t.start()
    ...
    def rename(self, oldpath, newpath):
        return self._sendCommand("rename",
                {"oldpath": oldpath, "newpath": newpath}, self.timeout)
